...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 8617341078739032968),
      name: 'Group',
      lastPropertyId: const IdUid(3, 4382217469805577208),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 7110168119761826935),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 3387167685852967180),
            name: 'name',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 4382217469805577208),
            name: 'color',
            type: 6,
            flags: 0)
      ],
  ...
  ModelEntity(
      id: const IdUid(2, 5447771651339234123),
      name: 'Task',
      lastPropertyId: const IdUid(4, 750605549810660025),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 7196178074786825360),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 3352039361449863927),
            name: 'description',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 3462518401308483293),
            name: 'completed',
            type: 1,
            flags: 0),
        ModelProperty(
            id: const IdUid(4, 750605549810660025),
            name: 'groupId',
            type: 11,
            flags: 520,
            indexId: const IdUid(1, 2634875930509821079),
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(2, 5447771651339234123),
      lastIndexId: const IdUid(1, 2634875930509821079),
