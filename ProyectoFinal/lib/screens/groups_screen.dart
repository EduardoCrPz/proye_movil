...
import 'package:proyectofinal/models/group.dart';
import 'package:proyectofinal/screens/add_group_screen.dart';
...
class GroupScreen extends StatefulWidget{
  ...
  @override
  State<GroupScreen> createState() => _GroupsScreenState();
}

class _GroupsScreenState extends State<GroupScreen>{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _groups.isEmpty? const Center(
